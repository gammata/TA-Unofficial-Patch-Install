...
2. Download [OTA.Dropin.Install.zip](https://github.com/vThaldren/TA-Unofficial-Patch-Install/blob/main/OTA.Dropin.Install.zip) and extract it into your game folder
3. Start TotalA.exe
